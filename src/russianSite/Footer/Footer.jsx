      ...
      <div className="container">
        ...
        <div className="footer__form-wrapper">
          <div className="footer__form-text-wrapper">
            <h2 className="title">Мы поможем вам сделать выбор</h2>
            <p className="subtitle subtitle--left">
              Напишите нам, если у вас есть вопросы по обучению или вам нужна
              помощь. Мы перезвоню тебе и поговорю с тобой
            </p>
            <p
            ...
            >
              Если возникли проблемы с формой, свяжитесь с нами в{' '}
              <span>
